...
import { FlatList, Image, StyleSheet, Text, View, Dimensions, FlatListProps, NativeSyntheticEvent, NativeScrollEvent } from 'react-native';
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.pagination}>
                <Text style={styles.paginationText}>{`${currentIndex + 1} / ${carouselData.length}`}</Text>
            </View>
        </View>
    );
};
